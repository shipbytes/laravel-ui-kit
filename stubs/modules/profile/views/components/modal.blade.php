...
>
    ...
    <div x-show="show"
        class="mb-6 bg-white dark:bg-zinc-900 rounded-xl overflow-hidden shadow-xl ring-1 ring-zinc-950/5 dark:ring-white/10 transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto"
